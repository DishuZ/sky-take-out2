...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        orders.setPayStatus(Orders.UN_PAID);      // 生成的订单为“未支付状态”
        orders.setStatus(Orders.PENDING_PAYMENT); // 付款状态为“待付款”
    ...
    public void paySuccess(String outTradeNo) {
        ...
        // 通过 websocker 向客户端浏览器推送消息 type orderId content
        Map map = new HashMap();
